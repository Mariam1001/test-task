                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header justify-content-center"><h3 class="fw-light my-4 text-center">Login User account</h3></div>
                            <div class="card-header justify-content-center"><a href="{{ route('admin.loginView') }}">Go to Admin Login</a></div>
